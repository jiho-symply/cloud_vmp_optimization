...
def parse_args():
    ...
    parser.add_argument("--objective-type", type=str, default=OBJECTIVE_TYPE, choices=["server_count", "energy"])
    parser.add_argument("--lambda-migration", type=float, default=LAMBDA_MIGRATION)
    parser.add_argument("--energy-idle", type=float, default=ENERGY_IDLE)
    parser.add_argument("--energy-cpu", type=float, default=ENERGY_CPU)
    parser.add_argument("--energy-migration", type=float, default=ENERGY_MIGRATION)
