...
ANALYSIS_DIR = EXPERIMENT_DIR / "results" / "analysis" / "chance_2sp_toy_12vm_decomposition_benchmark"
...
DECOMPOSITION_PROFILES = [
    {
        ...
        "strategy_type": "plain",
        "notes": "decomposition 미적용 control",
    },
    {
        "name": "control_state_link",
        "cut_profile": "state_link",
        "strategy_type": "plain",
        "notes": "bound 강한 control",
    },
    {
    ...
    },
    {
        ...
        "strategy_type": "hint",
        "start_strategy": "representative_peak",
        "notes": "집계 peak surrogate 해를 VarHint로만 주입",
    },
    {
        ...
        "notes": "시나리오 분리 해 다수결 합성 후 VarHint 주입",
    },
    {
    ...
    },
    {
        ...
        "notes": "Kwon 계열 rolling-horizon surrogate heuristic",
    },
    {
        ...
        "strategy_type": "hint",
        "start_strategy": "representative_peak",
        "notes": "bound 지향 cut에 peak hint 결합",
    },
    {
        ...
        "notes": "peak surrogate 해 주변 local branching",
    },
    {
        ...
        "start_strategy": "representative_peak",
        "window_size": 4,
        "notes": "peak surrogate 해 기준 time-window fix-and-optimize",
    },
]

CONTROL_PROFILES = ("control_combo_phi", "control_state_link")


def parse_args():
    parser = argparse.ArgumentParser(description="12VM decomposition benchmark with Kwon-inspired heuristics")
    ...
    parser.add_argument("--strategy-time-limit", type=int, default=20)
...
def write_report(screen_df, final_df, finalists, output_path, screen_time_limit, final_time_limit):
    lines = [
        ...
        "- control: `control_combo_phi`, `control_state_link`",
        "- decomposition 축: representative surrogate, scenario consensus, Kwon threshold, Kwon rolling horizon, local branching, fix-and-optimize",
        "",
        "## 최종 재실행 대상",
        "",
    ]
    ...
    lines += [
        ...
        "- `rolling_horizon_mean`은 rolling-horizon optimization 패턴을 집계 시나리오 해 생성에 적용한 것이다.",
        "- `scenario_consensus`는 scenario decomposition / PH 계열에서 공통 1단계 결정을 뽑아내는 간단한 휴리스틱 대체재다.",
        "- `local_branch`와 `fix_opt`는 decomposition이 만든 feasible seed를 neighborhood search로 다듬는 후처리 단계다.",
        "",
    ]
