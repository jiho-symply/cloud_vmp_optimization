...
DATA_FILE = REPO_ROOT / "data" / "processed" / EXPERIMENT_NAME / "sample_vm_data.csv"
RESULTS_DIR = REPO_ROOT / "results" / EXPERIMENT_NAME / "runs"
...
if __name__ == "__main__":
    ...
    # Solve
    optimize_and_save(m, out_dir=RESULTS_DIR / curr_timestamp)
